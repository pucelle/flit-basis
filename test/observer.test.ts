import {observe, observeComponentTarget, startUpdating, endUpdating, clearDependenciesOf, observeGetting} from '../src/observer/index'


describe('Test observer', () => {
	let a = observeComponentTarget({p: true, update: jest.fn()})
	let b = observeComponentTarget({p: true, update: jest.fn()})
